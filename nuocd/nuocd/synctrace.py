        ...
        if self._relative:
            if self._lastnow != None:
                ...
                for name,(numLocks,numUnlocks,numStalls,totalTimeStalls,maxStallTime) in stalls.iteritems():
                    ...
                    if numStalls > 0:
                        print Monitor.format % (ntime,nodeId,startId,hostname,pid,dbname,timedelta,total-ototal,name,
            ...
            if self._lastnow != None:
                ...
                timedelta = 0
            for name,(numLocks,numUnlocks,numStalls,totalTimeStalls,maxStallTime) in stalls.iteritems():
                print Monitor.format % (ntime,startId,hostname,pid,dbname,timedelta,total,name,
                                        numLocks,numUnlocks,numStalls,totalTimeStalls,maxStallTime)
