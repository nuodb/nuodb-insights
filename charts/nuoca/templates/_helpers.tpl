...
{{- $hostname := default (printf "%s-influxdb.%s.svc" .Release.Name .Release.Namespace) .Values.influxdb.host -}}
{{- $port     := default 8086 .Values.influxdb.port | toString -}}
{{- printf "http://%s:%s" (tpl $hostname .) (tpl $port .) -}}
{{- end -}}
